    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-lg">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 mb-6 mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              >
                * &apos;test&apos;를 입력하면 브랜드 대시보드로 이동합니다
              </p>
            </div>

            <button
              type="submit"
              className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:opacity-90 transition-opacity cursor-pointer"
            >
              브랜드로 등록하기
            </button>
          </form>
